    ...
    <view class="voice_teacher_box">
      <view class="voice_teacher">
        <view class="item_list">
          ...
          <view class="content" @click="handleCheckdemand">
            <text class="nickname">点击查看</text>
            <image
              class="yhjright"
              src="@/static/coupons/yhjright.png"
              mode="scaleToFill"
        ...
        <view class="item_list">
          ...
          <view class="content" @click="handleCheckdemand">
            <text class="nickname"
              >{{ paymentData.demand.draft_word_count }}字</text
            >
            <image
              class="yhjright"
              src="@/static/coupons/yhjright.png"
...
export default {
  ...
  onLoad(options) {
    (this.demand_id = options.id), (this.teacher_id = options.teacher_id);
    this.getPaymentData();
  },
  methods: {
    getPaymentData() {
